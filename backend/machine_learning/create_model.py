...
model = TFBertForTokenClassification.from_pretrained("bert-base-uncased",num_labels=INPUT_SIZE)
...
#sentences are stored as [['Sentence1'][Sentence2]] --> sentence[0] = Sentence1
for sentence in sentences.values:
    x = tokenizer.encode(sentence[0],padding='max_length',max_length=INPUT_SIZE)
...
full_model.fit(sentences,
          {"Action":actions, "Noun":shapes,"Color":colors, "Rel_Action": rel_actions, "Rel_Noun": rel_shapes, "Rel_Color":rel_colors},
