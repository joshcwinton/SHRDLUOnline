...
NOUNS = {
    'CUBE': CUBE_SYNONYMS,
    'PYRAMID': PYRAMID_SYNONYMS,
    'SPHERE': SPHERE_SYNONYMS}
...
# Relative nouns are not counted - Not sure to add in shapes or create new
# category "rel_shapes"
STATS_DATA = {'ACTIONS': {
    'ADD': 0,
    'FIND': 0,
            ...
            if relative_action:
                ...
                for rel_noun_synonym in NOUNS[relative_object.upper()]:
                    ...
                    for rel_action_synoynm in RELATIVE_ACTIONS[relative_action.upper(
                        ...
                        data.append([new_sentence3,
                                     ACTIONS_LIST[action],
                                     NOUN_LIST[noun],
                                     COLORS_LIST[color],
                                     REL_ACTIONS_LIST[relative_action],
                                     NOUN_LIST[relative_object],
...
if __name__ == '__main__':
    ...
    with open(TRAINING_SENTENCES_FILE, 'r') as csv_file:
        ...
        for row in csv_reader:
            ...
            if not save_Sentence_Structure(
                    action=action,
                    noun=noun,
                    color=color,
                    sentence=sentence,
            ...
            unique_sentences = create_Sentences(
                action=action,
                noun=noun,
                color=color,
                sentence=sentence,
